...
\section{Summary}
\label{C4:Summary}
\added{Below, I map the chapters insights onto the relevant research questions that I set to answer at the start of this thesis. Check appendix \ref{Appendix:ResearchQuestionsMapped} for the full table}
...
\newpage
In this chapter, I have provided a reflective account of two studies where I worked closely with people with dementia and their family members. The focus of the chapter is to \added{highlight} the implications of designing participatory activities within this space. Through these studies, I reflect on the role of building and maintaining relationships with participants and organisations. As I describe towards the end of the chapter, this has necessitated working closely with people with dementia to engage in open and exploratory design responses to their lived experiences, which required my own upskilling and education within HCI and dementia. Coming from a computer science background, I missed many opportunities to gain experience in \added{social research} that I might be building for as a developer or designer. Ensuring I respected and involved people with dementia in various ways throughout the studies required a longer-term commitment to get to know the \added{members of Silverline Memories}, conduct \added{sensitive} studies and learn about participatory methodologies simultaneously. However, this is not always possible in real-world design situations where research and design are undertaken at a quick and agile pace. 

\added{For instance, one popular approach in the tech industry for quick and agile methods is the conducting of hackathons. The events have been said to} \textit{’offer new opportunities and challenges for cooperative work by affording explicit, predictable, time-bounded spaces for interdependent work and access to new audiences of collaborators’} \citep{filippova_hacking_2017}. \added{Originating within the tech industry as competitive over-night coding events} \citep{jones_theres_2015}, \added{hackathons are events where designers, developers collaborate over a short intensive period (typically a weekend), on software or design projects} \citep{nandi_hackathons_2016}. \added{Typically, hackathons have been organised and sponsored by businesses or universities to provide undergraduates with the opportunity to learn and practice new skills and potentially building connections between the attendee and organisation recruiters or employees. Hackathons are often coupled with rewards and prize money for the winning team as an enticement to spend time building a demo and/or presentation} \citep{jones_theres_2015}. \added{As such, given the popularity in design events such as hackathons to upskill people on a range of topics, the following chapter explores the restructuring of hackathons to accustom marginalised populations - particularly those with dementia. Further, the next chapter examines how design can provide and support education to those without lived experiences of dementia.}
 
\added{Finally, through co-designing days out and tailoring VR and media experiences with families with dementia, these studies provide insights into ways to treat the person with dementia as an individual; working within ecologies of care; and acknowledging the ways to design for being in the moment rather than relying on reminiscence. As such, this chapter raises numerous ethical complexities such as consent, ethical 'protectionism', and robustness of technology. Given the variety of ethical challenges faced in this study, chapter six investigates the types of ethical concerns HCI researchers face in the dementia context.}
